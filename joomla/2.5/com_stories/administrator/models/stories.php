...
class StoriesModelStories extends JModelList {
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__stories_story` AS a');
		...
		$query->select('#__stories_category_1152339.name AS categories_name_1152339');
		$query->join('LEFT', '#__stories_category AS #__stories_category_1152339 ON #__stories_category_1152339.id = a.categories');
		// Join over the foreign key 'subcategories'
		$query->select('#__stories_subcategory_1152340.name AS subcategories_name_1152340');
		$query->join('LEFT', '#__stories_subcategory AS #__stories_subcategory_1152340 ON #__stories_subcategory_1152340.id = a.subcategories');
		// Join over the foreign key 'rating'
		$query->select('#__stories_rating_1152349.name AS ratings_name_1152349');
		$query->join('LEFT', '#__stories_rating AS #__stories_rating_1152349 ON #__stories_rating_1152349.id = a.rating');
