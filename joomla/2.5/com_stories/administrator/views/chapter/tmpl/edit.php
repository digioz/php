...
<script type="text/javascript">
    ...
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',function() {
        ...
        js(document).ready(function(){
					...
					js('input:hidden.story').each(function(){
						var name = js(this).attr('name');
						if(name.indexOf('storyhidden')){
							js('#jform_story option[value="'+jQuery(this).val()+'"]').attr('selected',true);
						}
					});
...
<form action="<?php echo JRoute::_('index.php?option=com_stories&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="chapter-form" class="form-validate">
    <div class="width-60 fltlft">
        <fieldset class="adminform">
            <legend><?php echo JText::_('COM_STORIES_LEGEND_CHAPTER'); ?></legend>
