...
class StoriesTablestory extends JTable {
    ...
    public function __construct(&$db) {
        parent::__construct('#__stories_story', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '') {
        ...
        if (!JFactory::getUser()->authorise('core.admin', 'com_stories.story.' . $array['id'])) {
            $actions = JFactory::getACL()->getActions('com_stories', 'story');
            $default_actions = JFactory::getACL()->getAssetRules('com_stories.story.' . $array['id'])->getData();
            $array_jaccess = array();
    ...
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_stories.story.' . (int) $this->$k;
    }
