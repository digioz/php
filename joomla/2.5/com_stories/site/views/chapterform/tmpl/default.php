...
<script type="text/javascript">
    ...
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',function() {
        ...
        js(document).ready(function(){
            js('#form-chapter').submit(function(event){
...
<div class="chapter-edit front-end-edit">
    ...
    <form id="form-chapter" action="<?php echo JRoute::_('index.php?option=com_stories&task=chapter.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>
            				<li><?php echo $this->form->getLabel('id'); ?>
				<?php echo $this->form->getInput('id'); ?></li>
				<li><?php echo $this->form->getLabel('title'); ?>
				<?php echo $this->form->getInput('title'); ?></li>
				<li><?php echo $this->form->getLabel('story'); ?>
				<?php echo $this->form->getInput('story'); ?></li>

			<?php
				foreach((array)$this->item->story as $value): 
					if(!is_array($value)):
						echo '<input type="hidden" class="story" name="jform[storyhidden]['.$value.']" value="'.$value.'" />';
					endif;
				endforeach;
			?>
			<script type="text/javascript">
				window.onload = function(){
					jQuery.noConflict();
					jQuery('input:hidden.story').each(function(){
						var name = jQuery(this).attr('name');
						if(name.indexOf('storyhidden')){
							jQuery('#jform_story option[value="'+jQuery(this).val()+'"]').attr('selected',true);
						}
					});
				}
			</script>				<li><?php echo $this->form->getLabel('author'); ?>
        ...
        <div>
            ...
            <?php echo JText::_('or'); ?>
            <a href="<?php echo JRoute::_('index.php?option=com_stories&task=chapterform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>

            <input type="hidden" name="option" value="com_stories" />
            <input type="hidden" name="task" value="chapterform.save" />
