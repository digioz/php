 ...
 * Stories model.
 */
class StoriesModelStoryForm extends JModelForm
{
	...
	protected function populateState()
	{
        ...
        if (JFactory::getApplication()->input->get('layout') == 'edit') {
            $id = JFactory::getApplication()->getUserState('com_stories.edit.story.id');
        } else {
            $id = JFactory::getApplication()->input->get('id');
            JFactory::getApplication()->setUserState('com_stories.edit.story.id', $id);
        }
		$this->setState('story.id', $id);

		// Load the parameters.
        $params = $app->getParams();
        $params_array = $params->toArray();
        if(isset($params_array['item_id'])){
            $this->setState('story.id', $params_array['item_id']);
        }
	...
	{
		// Get the id.
		$id = (!empty($id)) ? $id : (int)$this->getState('story.id');
	...
	{
		// Get the form.
		$form = $this->loadForm('com_stories.story', 'storyform', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
	...
	{
		$data = JFactory::getApplication()->getUserState('com_stories.edit.story.data', array());
        if (empty($data)) {
            $data = $this->getData();
        }
