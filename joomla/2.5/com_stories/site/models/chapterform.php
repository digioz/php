 ...
 * Stories model.
 */
class StoriesModelChapterForm extends JModelForm
{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_stories.chapter', 'chapterform', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
	...
	{
		$id = (!empty($data['id'])) ? $data['id'] : (int)$this->getState('chapter.id');
