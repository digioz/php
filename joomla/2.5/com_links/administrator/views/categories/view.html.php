 ...
 */
class LinksViewCategories extends JView
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		$canDo	= LinksHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_LINKS_TITLE_CATEGORIES'), 'categories.png');
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_links');
		}
