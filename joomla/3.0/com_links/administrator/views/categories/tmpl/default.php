...
<form action="<?php echo JRoute::_('index.php?option=com_links&view=categories'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div class="clearfix"> </div>
		...
		<thead>
			<tr>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_LINKS_CATEGORIES_NAME', 'a.name', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_LINKS_CATEGORIES_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
				</th>
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_links&task=category.edit&id='.(int) $item->id); ?>">
