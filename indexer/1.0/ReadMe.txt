Thank You for Choosing the DigiOz Directory Indexer Version 1.0. 

What's New in Version 1.0:
--------------------------
- You can display a list of available files in the "files" directory and post a link to each.
- You can change the number of columns that the files are shown on the page.
...
Note: The script will list "ANY" type of file that you place in the "files" folder.
