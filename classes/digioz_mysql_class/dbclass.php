...
class dbClass
{
    ...
    // Open Database Connection for Stored Procedure with Select ----------
    
    function openConnectionWithFlag($flag)
    {
        $this->conn = mysql_connect($this->dbHost, $this->dbUser, $this->dbPass, false, $flag)or die ("Error Connecting to Database!");
        mysql_select_db($this->dbName);
    }
