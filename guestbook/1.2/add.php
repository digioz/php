...
echo "<center><h2>Guestbook Entry Result:</h2></center>";
...
$temp3 = stripslashes($yourmessage);
  ...
  echo "<b>Your Message:</b> $temp3 <br>";

  $outputstring = "<b>Date:</b> ".$date."<br><b>From:</b> ".$yourname."<br><b>Email:</b> <a href=mailto:$youremail>".$youremail."</a><br><br><b>Message:</b> ".$yourmessage."<hr>\n";
