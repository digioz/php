...
if (!is_numeric($gbNameId) || $gbNameId > COUNT($gbName))
{
    $gbNameId = 1;
}
...
$filename = "data/list".$gbNameId.".txt";
...
{
echo "<br><a href=\"list.php?page=$fwd&order=$order&gb=$gbNameId\">&lt&lt</a>";
echo "<a href=\"list.php?page=$rwd&order=$order&gb=$gbNameId\">&gt&gt</a><br>";
}
else if ($fwd == 0)
{ echo "<a href=\"list.php?page=$rwd&order=$order&gb=$gbNameId\">&gt&gt</a><br>"; }
else if ($rwd == 0)
...
{ echo "<a href=\"list.php?page=$fwd&order=$order&gb=$gbNameId\">&lt&lt</a><br>"; }


for ($i = 1; $i<=$totalpages; $i++)
{
echo " <b>[ <a href=\"list.php?page=$i&order=$order&gb=$gbNameId\"><b>$i</b></a> ]</b> ";
}
echo "</center>";
