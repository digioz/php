...
//$search = filter_var($_POST['search_term'], FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_LOW);       // get user search information 
//$pageNum = filter_var($_GET['page'],FILTER_SANITIZE_NUMBER_INT);             // generated only on multi-page results and selected by user
